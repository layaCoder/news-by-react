        ...
        <Row>
         <Col span={24}>
           ...
           <Form onSubmit={this._handleSubmit.bind(this)}>
            <FormItem label="您的评论">
           {getFieldDecorator ('remark',{initalValue:''})  ( <Input type="textarea" placeholder="评论内容" /> )}
            </FormItem>
            <Button type="primary" htmlType="submit">提交评论</Button>
            &nbsp;&nbsp;
            <Button type="primary" htmlType="button" onClick={this._addUserCollection.bind(this)}>收藏该文章</Button>
           </Form>
